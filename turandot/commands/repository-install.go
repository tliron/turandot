...
func init() {
	...
	repositoryInstallCommand.Flags().StringVarP(&registry, "registry", "g", "docker.io", "registry address (use special value \"internal\" to discover internally deployed registry)")
