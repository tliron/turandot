	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TurandotV1alpha1().Repositories(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TurandotV1alpha1().Repositories(namespace).Watch(context.TODO(), options)
			},
		},
		&turandotpuccinicloudv1alpha1.Repository{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *repositoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&turandotpuccinicloudv1alpha1.Repository{}, f.defaultInformer)
}
